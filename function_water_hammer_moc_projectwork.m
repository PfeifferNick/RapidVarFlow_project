...
if mode == "surgeTank"
    ...
    nsT = n-n/10%round(n/2)+1; % if n=5, nsT=4
    AsT = 5 ;% AsT Area of surge tank 20 m^2
...
if mode == "airChamber"
    ...
    A_air = 20; % Area of air chamber [m^2]
...
% Pipe 2 
rough2 = 0.00015; % pipe roughness [m] (steel)
...
% Pipe 3 
rough3 = 0.00015; % pipe roughness [m] (steel)
...
fprintf('wave speed alpha pipe 1 = %g, wave speed alpha pipe 2 = %g, wave speed alpha pipe 3 = %g\n',alpha1,alpha2,alpha3);
