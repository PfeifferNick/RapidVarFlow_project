...
% E=2.1*10^11; % Youngs modulus of the pipe [N/m2] (steel)
% u = 0.30; % Poisson ratio [-] (steel)

% Ductile Iron:
% rough=0.00115; % pipe roughness [m] (ductile iron)
% E=  172e9; % Youngs modulus of the pipe [N/m2] (ductile iron)
% u = 0.33; % Poisson ratio [-] (ductile iron)

% Reinforced Concrete:
rough = 0.0003; % pipe roughness [m] (reinforced concrete)
E = 45*10^9; % Youngs modulus of the pipe [N/m2](reinforced concrete)
u = 0.15; % Poisson ratio [-] (reinforced concrete)

% GRP:
% rough=0.00003; % pipe roughness [m] (GRP)
% E=  50e9; % Youngs modulus of the pipe [N/m2] (GRP)
% u = 0.35; % Poisson ratio [-] (GRP)
...
% 
save('H_min_env_Concrete','H_min_env'  )

save(  'H_max_env_Concrete','H_max_env' )